...
import (
	...
	fruit "zeng.dev/kube-template/client/informers/fruit"
	internalinterfaces "zeng.dev/kube-template/client/informers/internalinterfaces"
	template "zeng.dev/kube-template/client/informers/template"
...
func (f *sharedInformerFactory) Fruit() fruit.Interface {
	return fruit.New(f, f.namespace, f.tweakListOptions)
}
