	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.TemplateV1().Samples(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TemplateV1().Samples(namespace).Watch(context.TODO(), options)
			},
		},
		&templatev1.Sample{},
		resyncPeriod,
...
func (f *sampleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&templatev1.Sample{}, f.defaultInformer)
}
